...
function api_list_form($classid,$offset) {
  //前台筛选显示调用
  $tmpstr = ii_ireplace('global.expansion/fields:api.listform', 'tpl');
...
function api_list_sorts() {
  //前台筛选显示调用
  global $conn, $ngenre, $nlng;
  $tmpstr = ii_ireplace('global.expansion/fields:api.listsort', 'tpl');
  $tmpstr = vv_isort($ngenre, 'tpl=global.expansion/fields:api.listsort');
  return $tmpstr;
}
...
function api_get_fields_textarea($oid,$gid)
{
  ...
  $ffpre = mm_cnfpre(ii_cvgenre($fgenre));
  $tid = $oid;
  $tmpstr = ii_itake('global.expansion/fields:api.gettextarea', 'tpl');
  if (!ii_isnull($tmpstr))
  {
    $tsqlstr = "select * from $fdatabase where $fidfield=$tid";
    $trs = ii_conn_query($tsqlstr, $conn);
...
function api_get_fields_upload($oid,$gid)
{
  ...
  $ffpre = mm_cnfpre(ii_cvgenre($fgenre));
  $tid = $oid;
  $tmpstr = ii_itake('global.expansion/fields:api.getupload', 'tpl');
  if (!ii_isnull($tmpstr))
  {
    $tsqlstr = "select * from $fdatabase where $fidfield=$tid";
    $trs = ii_conn_query($tsqlstr, $conn);
...
function api_get_fields_gallery($oid,$gid)
{
  ...
  $ffpre = mm_cnfpre(ii_cvgenre($fgenre));
  $tid = $oid;
  $tmpstr = ii_itake('global.expansion/fields:api.getgallery', 'tpl');
  if (!ii_isnull($tmpstr))
  {
    $tsqlstr = "select * from $fdatabase where $fidfield=$tid";
    $trs = ii_conn_query($tsqlstr, $conn);
...
function api_fields_textarea($oid)
{
  ...
  $ffpre = mm_cnfpre(ii_cvgenre($fgenre));
  $tid = $oid;
  $tmpstr = ii_itake('global.expansion/fields:api.textarea', 'tpl');
  if (!ii_isnull($tmpstr))
  {
    $tsqlstr = "select * from $fdatabase where $fidfield=$tid";
    $trs = ii_conn_query($tsqlstr, $conn);
...
function api_fields_upload($oid)
{
  ...
  $ffpre = mm_cnfpre(ii_cvgenre($fgenre));
  $tid = $oid;
  $tmpstr = ii_itake('global.expansion/fields:api.upload', 'tpl');
  if (!ii_isnull($tmpstr))
  {
    $tsqlstr = "select * from $fdatabase where $fidfield=$tid";
    $trs = ii_conn_query($tsqlstr, $conn);
...
function api_fields_gallery($oid)
{
  ...
  $ffpre = mm_cnfpre(ii_cvgenre($fgenre));
  $tid = $oid;
  $tmpstr = ii_itake('global.expansion/fields:api.gallery', 'tpl');
  if (!ii_isnull($tmpstr))
  {
    $tsqlstr = "select * from $fdatabase where $fidfield=$tid";
    $trs = ii_conn_query($tsqlstr, $conn);
