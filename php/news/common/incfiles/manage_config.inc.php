...
function wdja_cms_admin_manage_adddisp()
{
  ...
  if (!($tclass == 0))
  {
    ...
    '$timage',
    '" . ii_left(ii_cstr($_POST['gallery']), 10000) . "',
    '$tcontent',
    '$tcontent_atts_list',
    '" . ii_left(ii_cstr($_POST['shop_lists']), 50) . "',
...
function wdja_cms_admin_manage_editdisp()
{
  ...
  if (!($tclass == 0))
  {
    ...
    " . ii_cfname('gallery') . "='" . ii_left(ii_cstr($_POST['gallery']), 10000) . "',
    " . ii_cfname('content') . "='$tcontent',
    " . ii_cfname('content_atts_list') . "='$tcontent_atts_list',
    " . ii_cfname('shop_lists') . "='" . ii_left(ii_cstr($_POST['shop_lists']), 50) . "',
