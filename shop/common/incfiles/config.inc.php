...
$ndatabase_price = $variable[ii_cvgenre($ngenre) . '.ndatabase_price'];
$nidfield_price = $variable[ii_cvgenre($ngenre) . '.nidfield_price'];
$nfpre_price = $variable[ii_cvgenre($ngenre) . '.nfpre_price'];
