    ...
    init: function (){
      ...
      ajax.onreadystatechange = function () {
         if (ajax.readyState==4 &&ajax.status==200) {
            var dict = Storages.getParam("dict");
            if(dict==null||dict=="") Storages.setParam("dict",ajax.responseText);
          }
      }
      //console.log(menuData);
  }
}
var menuData = JSON.parse(Storages.getParam("dict"));
