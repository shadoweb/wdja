...
define('DB_USERNAME','wdja');
define('DB_PASSWORD','wdja');
define('DB_DATABASE','wdja');
...
define('MOBILE_SKIN','default');
define('ROBOTS_SKIN','default');
...
define('SMTPPORT','465');
define('SMTPUSERNAME','********@qq.com');
define('SMTPPASSWORD','********');
define('SMTPFROMNAME','********@qq.com');
define('API_ID','P8N800IVSG3QCBDU');
define('API_KEY','781TY9MMSQ4BCPVB38Q7J273UD8IGW75');
define('OSS_SWITCH','0');
define('OSS_ID','********');
define('OSS_KEY','********');
...
$wxpayjs_id = '';
$wxpayjs_key = '';
$wxpayjs_notify = 'http://********/user/payjs_notify.php';
$alipayjs_id = '';
$alipayjs_key = '';
$alipayjs_notify = 'http://********/user/payjs_notify.php';
$alipay_appid = '';
$alipay_public_key = '';
$alipay_private_key = '';
$alipay_notify_url = 'http://********/user/alipay_notify.php';
$alipay_return_url = 'http://********/user/alipay_return.php';
$wxpay_token = '';
$wxpay_appid = '';
$wxpay_appsecret = '';
