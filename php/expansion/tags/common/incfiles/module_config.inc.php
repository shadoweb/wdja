...
function wdja_cms_module_detail()
{
  ...
  if (ii_isnull($tshkeyword)) {
      ...
      if ($trs)
      {
        ...
        $tshkeyword = ii_get_safecode($trs[ii_cfname('topic')]);
      }
  }
  global $variable, $nvalidate, $nlng;
  ...
  $tmpstr = str_replace('{$cpagestr}', $tcp -> get_pagenum('detail'), $tmpstr);
