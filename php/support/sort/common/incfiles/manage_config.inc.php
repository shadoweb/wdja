...
function wdja_cms_admin_manage_adddisp()
{
  ...
  $ttitles = ii_get_safecode($_POST['titles']);
  $tkeywords = ii_get_safecode($_POST['keywords']);
  $tdescription = ii_get_safecode($_POST['description']);
  $timage = ii_get_safecode($_POST['image']);
  $ttpl_list = ii_get_safecode($_POST['tpl_list']);
  $ttpl_detail = ii_get_safecode($_POST['tpl_detail']);
...
function wdja_cms_admin_manage_editdisp()
{
  ...
  if ($tid !=$tfsid ) {
    ...
    if (strlen($tfid) < 255)
    {
      ...
      " . ii_cfname('tpl_list') . "='$ttpl_list',
      " . ii_cfname('tpl_detail') . "='$ttpl_detail',
