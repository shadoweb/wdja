...
function wdja_cms_admin_manage_editdisp_home()
{
  global $nsaveimages;
  ...
  $tbase = 'language_list';
  $torder = 'slide_num,sort_list,sort_list_num,images_list,images_list_num,imagestext_list,imagestext_list_num,text_list,text_list_num,';
...
function wdja_cms_admin_manage_action()
{
  ...
  {
    case 'home':
      wdja_cms_admin_manage_editdisp_home();
      break;
    case 'upload':
      uu_upload_files();
      break;
...
function wdja_cms_admin_manage_edit($type = 'home')
{
  global $conn;
...
function wdja_cms_admin_manage()
{
  ...
  {
    case 'home':
      return wdja_cms_admin_manage_edit('home');
      break;
    case 'upload':
